...
public class ButtonNextEntity implements EntityBase
{
    ...
    public void Init(SurfaceView _view) {
        ...
        // Load the images.
        bmpP = ResourceManager.Instance.GetBitmap(R.drawable.button_next);
    ...
    public static ButtonNextEntity Create() {
        ButtonNextEntity result = new ButtonNextEntity();
