...
public class ButtonSkillEntity implements EntityBase
{
    ...
    public void Init(SurfaceView _view) {
        ...
        // Load the images.
        bmpP = ResourceManager.Instance.GetBitmap(R.drawable.button_skill);
        bmpP1 = ResourceManager.Instance.GetBitmap(R.drawable.button_skill_pressed);
    ...
    public static ButtonSkillEntity Create() {
        ButtonSkillEntity result = new ButtonSkillEntity();
