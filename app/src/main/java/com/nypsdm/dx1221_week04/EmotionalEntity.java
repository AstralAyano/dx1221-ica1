...
public class EmotionalEntity implements EntityBase, Collidable {
    ...
    public void Init(SurfaceView _view) {
        ...
        spritesheet = new Sprite(ResourceManager.Instance.GetBitmap(R.drawable.emotional), 1, 4, 30);
    ...
    public static EmotionalEntity Create() {
        EmotionalEntity result = new EmotionalEntity();
