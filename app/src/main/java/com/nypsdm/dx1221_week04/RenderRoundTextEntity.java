...
public class RenderRoundTextEntity implements EntityBase
{
    // Paint Object
    ...
    public static RenderRoundTextEntity Create()
    {
        RenderRoundTextEntity result = new RenderRoundTextEntity();
    ...
    public void SetValues(int round)
    {
        roundNo = round;
    }
}
